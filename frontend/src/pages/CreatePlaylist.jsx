...
const CreatePlaylist = () => {
  ...
  return (
    <div className="bg-slate-800 text-teal-200 flex justify-start flex-col p-5 space-y-10 min-h-screen pb-32 ">
      <p className="text-2xl">Todas las Playlists</p>
      ...
      {loading && playlists == null ? (
        ...
        <div className="flex justify-center items-center text-2xl">Playlist no encontrada</div>
      )}
      ...
      >
        <GrFormAdd />
        <span className="text-gray-900">Crear Playlist</span>
      </div>
